					...
					<div class="row">
						...
						<table style="font-size: 15px;background: white;font-weight: 500;" class="table table-responsive table-hover" border="1">
							...
							<tr>
								...
								<td><b>Image Update</b></td>
							</tr>
							<?php
            
            $sliderdata = "SELECT * FROM `imageinfo`";
            ...
            while($row=mysqli_fetch_row($result))
            {
                ?>
								...
								<tr>
									...
									<td><img width="300" src="uploads/<?php echo $row[1]; ?>" /> </td>
									<td style="text-align:center;vertical-align: middle;">
										<a  href="delete.php?id=<?php echo $row[0]; ?>"><img width="50" src="img/delete.png" /> </a>
									</td>
									<td style="text-align:center;vertical-align: middle;">
										<a  href="update.php?id=<?php echo $row[0]; ?>"><img width="50" src="img/edit.png" /> </a>
									</td>
