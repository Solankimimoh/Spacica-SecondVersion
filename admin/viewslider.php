                ...
                <div class="content-frame-body content-frame-body-left">
                    ...
                    <div class="row">
                        ...
                        <table style="font-size: 15px;background: white;font-weight: 500;"   class="table table-responsive table-hover" border="1">
                            ...
                            <tr>
                            <td><b>Slider Image Name</b></td>
                            <td><b>Slider Image Type</b></td>
                            <td><b>Slider Image View</b></td>
                            <td><b>Slider Image Delete</b></td>
                            </tr>
                             <?php
            ...
            while($row=mysqli_fetch_row($result))
            {
                ?>
                            ...
                            <tr>
                                ...
                                <td><img width="300" src="uploads/slider/<?php echo $row[1]; ?>"/> </td>
