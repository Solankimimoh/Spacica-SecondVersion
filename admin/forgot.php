	...
	<div class="login-container">
		...
		<div class="login-box animated fadeInDown">
			...
			<div class="login-body" style="margin-top:6 0px;">
				<div class="login-title"><strong>Spacica</strong>, Forgot Password</div>
				<form action="forgotpwd.php" class="form-horizontal" method="post">
					...
					<div class="form-group">
						<div class="col-md-12">
							<input type="password" class="form-control" placeholder="Confirm new Password" name="cnfrmpassword" value="" />
						</div>
					</div>
					<div class="form-group">

						<div class="col-md-6">
							<input class="btn btn-info btn-block" type="submit" name="sbmt" value="Log In">
